public class StockData {
    ...
    public StockData(String date, double open, double high, double low, double close, int volume, double unadjustedClose, int unadjustedVolume, double change, double changePercent, double vwap, String label, double changeOverTime) {
        this.date = date;
        this.open = open;
        this.high = high;
        this.low = low;
